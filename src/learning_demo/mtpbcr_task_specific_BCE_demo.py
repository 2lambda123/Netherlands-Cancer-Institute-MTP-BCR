...
# MTP model params _220609 add more risk factor
# ---------------------------------
...
# def train_4views_stp_220613(model, data_loader, criterion, optimizer, epoch, args):
#
#     model.train()
...
#                                                         age_criterion)
#
#         loss = right_side_based_loss + left_side_based_loss + exam_based_loss
#
#         optimizer.zero_grad()
#         loss.backward()
#         optimizer.step()
...
#
#
# def validate_4views_stp_220613(model, valid_loader, criterion, args, poltroc=False, name='best model'):
#     model.eval()
...
#         logging.info(report)
#
#         risk_AUC = polt_roc_curve(args, all_risk_label, all_risk_probabilities, poltroc, name)
#
...
#
#
# def test_4views_stp_220613(model, test_loader, criterion, args, poltroc=False, name='best model'):
#     model.eval()
#     total_loss, risk_total_top1, total_num_patient = 0.0, 0.0, 0
#     all_risk_probabilities, all_risk_predicted, all_risk_label = [], [], []
#     risk_criterion = criterion['risk_criterion']
...
#         risk_cm = 'none'
#
#         risk_AUC = polt_roc_curve_with_CI(args, all_risk_label, all_risk_probabilities, poltroc, name)
#
